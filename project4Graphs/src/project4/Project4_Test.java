...
public class Project4_Test {
	...
	public static void main(String[] args){
		...
		System.out.println("bfs: " +test.bfs(0));
		
		
		System.out.println();
		
		System.out.println("dfs: " + test.dfs(0));
		
		
		System.out.println("dijkstras: " + test.dijkstras(0));
		
		System.out.println("shortest path: " + test.shortestPath(0));
		*/
