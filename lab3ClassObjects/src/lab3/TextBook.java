...
public class TextBook {
    ...
    */
    public ArrayList<PersonName> getAuthor() {
    	ArrayList<PersonName> another = new ArrayList<PersonName>();
    	for(int i = 0; i < author.size(); i++){
 
        // Create a new PersonName object
    	another.add(new PersonName(author.get(i).getFirstName(), author.get(i).getMiddleName(), author.get(i).getLastName()));
    ...
    */
    public void setAuthor(ArrayList<PersonName> a) {
    	...
    	for(int i = 0; i < a.size(); i++){
    		author.add(new PersonName(a.get(i)));
    	}
    }
    ...
    */
    public String toString() {
    	//create a new string that appends all the PersonNames in author in order 
    	//and checks to see if they are empty before appending
    	String a = "";
        for (int i=0; i < author.size(); i++){
        	String b = author.get(i).toString();
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof TextBook) {
                ...
                && keywords.size() == t.getKeywords().size())
            {
                ...
                //create another for loop that iterates through the list of authors to see if both authors contains the same size
                for(int i = 0; i < author.size(); i++){
